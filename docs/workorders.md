...
- **WO-040-IJ** — **skin colours + font colour** (pre-1.0 batch 3): consolidate state colours to four — Target (TTK) / Utility (waiting) / Utility (fire) / Utility (fired), dropping the duplicate Waiting (#1/#2); add a Font colour picker (#20); confirm skins save spacing/width/height (#22) (see `docs/workorders/WO-040-IJ.md`). Status: In progress — PR #44 open.
