...
- **WO-055-IJ** — **show icons**: utility bars show their ability icon + the TTK bar shows the current target's portrait (SetPortraitTexture, live) when Show icons is on; display.lua only (see `docs/workorders/WO-055-IJ.md`). Status: In progress — PR #58.
