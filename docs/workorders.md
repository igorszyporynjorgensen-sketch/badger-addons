...
- **WO-058-IJ** — **layout follow-up**: Behavior's two sliders share one row (0.49 each), Display's H·V·Scale share one row (0.33 each), header order Lock · Show preview · Play/Pause (see `docs/workorders/WO-058-IJ.md`). Status: Accepted — implementing.
