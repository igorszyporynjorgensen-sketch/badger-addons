...
- **WO-052-IJ** — **fix: header band leaks across the AceGUI frame pool** (audit #1, my WO-045 regression) + **master-switch gate** (audit #5); BadgerConfigUI teardown (MINOR 9→10) + driver enabled early-return (see `docs/workorders/WO-052-IJ.md`). Status: In progress — PR #55.
