...
- **WO-042-IJ** — **per-ability colour** (pre-1.0 batch 5): each Warrior ability gets a colour that overrides the global Utility (waiting) colour for its bar while waiting (#5) (see `docs/workorders/WO-042-IJ.md`). Status: In progress — PR #46 open.
