...
- **WO-043-IJ** — **config window: align status bar + Close button** with the content L/R inset (#16); a defensive `polishStatusBar` re-anchor in BadgerConfigUI (MINOR 7→8) (see `docs/workorders/WO-043-IJ.md`). Status: Accepted.
