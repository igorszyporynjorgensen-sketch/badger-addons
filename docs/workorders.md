...
- **WO-041-IJ** — **bar geometry & opacity** (pre-1.0 batch 4): two bar heights — TTK 30 / utility 20 (#4); border hugs the bar (#17); fill + background opacity sliders (#23/#24); TTK/utility text X-Y offsets (#25); all saved to skins (see `docs/workorders/WO-041-IJ.md`). Status: In progress — PR #45 open.
