...
- **WO-066-IJ** — **validate the estimator for party/raid + composition**: extend the sim harness with caster/melee/healer/heroism/immune-phase traces, document the analysis + roadmap (`docs/reference/estimator-party-raid.md`) (see `docs/workorders/WO-066-IJ.md`). Status: Accepted — implementing.
