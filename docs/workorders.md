...
- **WO-063-IJ** — **add Naxxramas** to the raid registry (the missing final Classic-Era tier); pure data addition to `ns.RaidTable`, 15 encounters, after AQ40 (see `docs/workorders/WO-063-IJ.md`). Status: In progress — PR #66.
