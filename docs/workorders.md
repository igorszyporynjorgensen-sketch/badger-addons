...
- **WO-048-IJ** — **fix: icons don't render** — the TGAs were top-origin (descriptor `0x28`); WoW needs bottom-origin. Fix `png-to-tga.py` to emit `0x08` + bottom-to-top rows, regenerate both `Media/*.tga` (see `docs/workorders/WO-048-IJ.md`). Status: In progress — PR #51 opened.
