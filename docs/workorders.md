...
- **WO-039-IJ** — **config copy** (pre-1.0 batch 2): deeper General how-to (#3/#13), a Behavior intro line (#26), intro text on the Raids + Abilities parent nodes (#6), sharper minTTK tooltip (#7) (see `docs/workorders/WO-039-IJ.md`). Status: Proposed.
