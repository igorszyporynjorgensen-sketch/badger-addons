...
- **WO-050-IJ** — **Text-offsets one row**: `width = 0.25` on the four TTK/Utility text-offset sliders so all four share a row (see `docs/workorders/WO-050-IJ.md`). Status: In progress — PR #53.
