...
- **WO-046-IJ** — **README overhaul**: rework README.md in the polished payload-wonderly/zenzo style (hero + badges + emoji sections + stack table + NOTE callout), promote **badger-ttk to first**, and reflect the **TBC Anniversary + Classic Era** target (#27/#28) (see `docs/workorders/WO-046-IJ.md`). Status: Accepted.
